...
> [!NOTE]   
> Por exemplo, a URL https://github.com/julioadm/dio-lab-open-source é o "**fork**" feito pelo usuário do GitHub "`julioadm.md`" para a contribuição no repositório `dio-lab-open-source`.
...
##
<div align="center">Feito com 💙 por <a href="https://github.com/elidianaandrade">Júlio</a>.</div>
