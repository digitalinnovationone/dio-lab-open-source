...
> [!NOTE]   
> Por exemplo, a URL https://github.com/julioadm/dio-lab-open-source é o "**fork**" feito pelo usuário do GitHub "`julioadm`" para a contribuição no repositório `dio-lab-open-source`.
