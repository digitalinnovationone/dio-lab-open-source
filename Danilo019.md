...
Repositório desenvolvido para fins didáticos, com a disponibilização de materiais de apoio e exercício prático para o lab **Contribuindo em um Projeto Open Source no GitHub** da [Digital Innovation One](https://www.dio.me/).
	@@ -10,13 +11,16 @@ Repositório desenvolvido para fins didáticos, com a disponibilização de mate
...
<table>
  <thead>
    <tr align="left">
	@@ -45,28 +49,32 @@ Aprender o básico sobre contribuição no GitHub.
</table>
...
> [!WARNING]  
	@@ -75,21 +83,42 @@ GitHub Discussions é um fórum de comunicação colaborativo dentro do GitHub.
---
