...
[![Card Streak States](https://img.shields.io/badge/Card%20Streak%20States-30A3DC?style=for-the-badge)](https://github.com/digitalinnovationone/dio-lab-open-source/blob/main/utils/cards/github-streak-stats.md)
...
> Para mais detalhes, veja o guia [CONTRIBUTING.md](https://github.com/digitalinnovationone/dio-lab-open-source/blob/main/CONTRIBUTING.md).

### Reportar Problemas

Se encontrar algum problema, por favor, abra uma [issue](https://github.com/digitalinnovationone/dio-lab-open-source/issues).

### Exemplos de Contribuições

Veja as contribuições anteriores na [página de contribuições](https://github.com/digitalinnovationone/dio-lab-open-source/graphs/contributors).
