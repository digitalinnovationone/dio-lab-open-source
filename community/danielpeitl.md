...
<h1 align="center">Bom dia, me chamo Daniel</h1>


 <h2>Sobre mim</h2> 
Formado em Ciência da Computação pela Unesp de Rio Preto, tenho paixão por sistemas de informação, em especial pelas estruturas de armazenamento de dados

Atuo como Analista de Sistemas / Gerente de Produto e estou voltando a estudar programação com foco em análise de dados.
