...
The Filmfrenzy project, for some reason it started to receive a lot of hits and ended up **running out of Vercel's bandwidth and image optimization limits**, I couldn't revert back and had to **delete my vercel account**, because of that some of these **projects will have broken links**, I'm already solving these problems and soon these **projects will be on air again soon**.
