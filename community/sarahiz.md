# A Importância da linguaguem Python

Bom, pessoal hoje iremos aprofundar nossos conhecimentos na importante linguagem Python ! print("Python") 
...
Se quiserem adaptar ou incluir informações específicas (ex: dependências, instruções de instalação, contato), por gentileza o mantenha informado!
(https://github.com/ricardodsr/Public_Python)
