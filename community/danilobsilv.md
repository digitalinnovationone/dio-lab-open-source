...
- 👨‍🏫 Estudante de Engenharia de Computação na  <a href=https://www1.uea.edu.br/event.php rel=external target=_blank >Universidade do Estado do Amazonas (UEA)</a>.
- 👀 Focado em aprender e dominar as ferramentas que a tecnologia pode me proporcionar.
- 🌱 Atualmente estudando Python e Java, com foco no desenvolvimento backend.
- 💞️ Procurando colaborar em projetos que possam me ajudar a melhorar meu senso crítico e lógico, e também ajudar a comunidade de programação.
