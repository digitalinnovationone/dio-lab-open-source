...
<div align="center">
  <img src="https://readme-typing-svg.herokuapp.com/?color=0E8AE6&size=35&center=true&vCenter=true&width=1000&lines=Bem+vindo(a)+ao+meu+Portfólio!" alt="Typing SVG" />
</div>
...
## 👨‍💻 Sobre Mim
Olá! Sou o Cezar, um profissional em transição de carreira com uma trajetória sólida de **16 anos no setor da aviação**. Essa bagagem me proporcionou competências críticas em resiliência, comunicação assertiva e um foco inabalável no sucesso do cliente.

Atualmente, estou finalizando minha graduação em **Gestão de Tecnologia da Informação**. Busco unir minha experiência em apoio operacional, prevenção de fraudes e SAC com o poder da análise de dados e da Inteligência Artificial para gerar valor real aos negócios.

---

## 🎯 Objetivos e Interesses
* 📊 **Data & BI:** Transformar dados brutos em informações estratégicas para a tomada de decisão.
* 🤝 **Customer Success:** Garantir a melhor jornada ao usuário final através de suporte consultivo e tecnológico.
* ☁️ **Cloud & IA:** Especialização em soluções Microsoft Azure para otimização de processos corporativos.

## 🛠️ Competências em Desenvolvimento
* **Lógica & Dados:** SQL, Excel Intermediário e Lógica de Programação.
* **Ferramentas Cloud:** Azure Machine Learning, Cognitive Search e IA Generativa.
* **Soft Skills:** Gestão de crises, atendimento especializado e visão analítica de processos.

## 💬 Idiomas
* 📚 **Inglês - Básico/Técnico:** Focado em documentação técnica e manuais de sistemas.
...
[![WhatsApp](https://img.shields.io/badge/WhatsApp-25D366?style=for-the-badge&logo=whatsapp&logoColor=white)](https://wa.me/5511988541006?text=Olá,%20vi%20o%20seu%20portfólio%20no%20GitHub%20e%20gostaria%20de%20conversar.)
