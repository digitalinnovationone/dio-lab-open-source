# Readme Rafael Melo Druzian

## Sobre mim
Desenvolvedor Full-Stack em formação pelo bootcamp da Labenu e graduado em Propaganda e Marketing, trazendo uma combinação única de habilidades técnicas e conhecimento estratégico. Ao longo do bootcamp, tenho trabalhado em projetos práticos e colaborativos, utilizando tecnologias como JavaScript, HTML, CSS, React, TypeScript e SQLite. Minha trajetória profissional abrangeu anos na área de marketing, culminando em uma experiência como gerente de mercado. A descoberta da tecnologia como parte essencial da operação despertou minha paixão pela área. Com uma base sólida em desenvolvimento Full-Stack e uma formação em marketing, estou preparado para abraçar desafios inovadores e criar soluções impactantes.
