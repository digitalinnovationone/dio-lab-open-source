...
<div>
    ...
    <p align="left">
        Estou concluindo formação técnica em Desenvolvimento de Sistemas através do programa <a href="[text](https://secti.es.gov.br/bolsa-tecnica)">Bolsa Técnica</a> que integra o Sistema Universidade do Espírito Santo – <a href="(https://universidades.es.gov.br/)">UniversidadES</a>, ofertado pela Secretaria da Ciência, Tecnologia, Inovação e Educação Profissional.
    </p>
    <p align="left">
        Já na graduação, estou no 3° período do curso <a href="[text](https://serra.ifes.edu.br/cursos/graduacao/tecnologia-em-sistemas-para-internet)">Tecnologia em Sistemas para Internet - EAD</a>, ofertado pelo Instituto Federal do Espírito Santo - <a href="[text](https://serra.ifes.edu.br/)">IFES Campus Serra</a> com fomento da UnAC - Universidade Aberta Capixaba. A UnAC faz parte do Sistema UniversidadES, criada pelo Governo do Estado do Espírito Santo.
    </p>
    <p align="left"></p>
