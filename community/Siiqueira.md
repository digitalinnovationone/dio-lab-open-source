# Olá, Eu sou o Siiqueira👋🏽
```
Git init
```
## 🚀 Sobre mim
Eu sou Analista de dados e analista de desempenho ⚽.
Estou em transição de carreira, passei os últimos 7 anos trabalhando como Gerente comercial e também sou Empreendedor(Como uma boa parte da população brasileira).
...
[![My Skills](https://skillicons.dev/icons?i=github,git,md,python,sqlite,r,mysql)](https://github.com/siiqueira)
