...
SysAdmin | Estudando DevOps/Cloud

Sou administrador de sistemas com experiência em gerenciamento de sistemas, suporte ao usuário, infraestrutura em ambientes Windows e Linux, e monitoramento com Zabbix e Grafana. Possuo habilidades em virtualização, banco de dados Oracle e soluções de backup e recuperação. Estou me especializando em DevOps e Cloud, meus conhecimentos incluem Linux, Cloud Computing, Docker, Kubernetes, Terraform, CI/CD e Grafana. Possuo habilidade de entender e resolver problemas complexos. Busco continuamente aprimorar minhas habilidades e conhecimentos.
