# ![DIO Logo](https://hermes.digitalinnovation.one/assets/diome/logo-minimized.png) Contribuindo em um Projeto Open Source no GitHub
...
1. **Introdução ao Lab**  
   Nesta etapa, você será apresentado ao laboratório e seus objetivos. Verá uma visão geral do que será abordado e como as atividades práticas serão conduzidas.

2. **Formas de Contribuir num Projeto Open Source**  
   Aqui você aprenderá sobre as diferentes maneiras de contribuir para um projeto open source, desde a correção de bugs até a documentação, passando pela criação de novas funcionalidades.

3. **Desenvolvendo e Enviando uma Contribuição**  
   Esta etapa orienta você no desenvolvimento de uma contribuição real para um projeto open source. Será mostrado como criar, testar e enviar um Pull Request corretamente.

4. **Dicas e Materiais de Apoio**  
   Por fim, esta seção fornece dicas úteis e recursos adicionais que ajudarão a melhorar suas contribuições, além de mostrar onde encontrar mais informações para se aprofundar no assunto.
