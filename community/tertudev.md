...
Sou um desenvolvedor backend com foco em Python, apaixonado por criar soluções eficientes, escaláveis e bem estruturadas. Tenho experiência com frameworks como **FastAPI** e **Django**, além de conhecimento sólido em **bancos de dados relacionais e não relacionais**, **testes automatizados** e **integração de APIs**.

Busco sempre aplicar boas práticas de desenvolvimento, como **Clean Code**, **SOLID** e **arquiteturas desacopladas**, contribuindo para times ágeis e projetos de alto impacto.
