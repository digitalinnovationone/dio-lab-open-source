# Olá, sou Paulo César (PCVCPAULO) :vulcan_salute:
...
## :ninja:Atuação Profissional
### :1st_place_medal: Contador no IFES Campus São Mateus
### :1st_place_medal: Inscrito no Curso de Extensão da UFPE
#### :game_die: Ciência de Dados para Contabilidade & Negócios - DataCoN
