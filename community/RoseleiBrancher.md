...
comprometida e dedicada em projetos de grande escala e relevância.
A empresa tem uma cultura que valoriza a inovação e a busca por soluções tecnológicas avançadas. Como parte da equipe, eu teria a oportunidade de trabalhar com as mais recentes tecnologias e contribuir para a transformação digital da instituição. Promover um ambiente de trabalho colaborativo e inclusivo, onde a diversidade de ideias e perspectivas são 
valorizadas, compartilhando conhecimentos e experiências com a oportunidade de trabalhar em equipe com profissionais talentosos e engajados.
Na programação tenho ótimos conhecimentos de Front-end com tecnologias como: HTML , CSS, JavaScript, OutSystems, Wordpress, Python, Power BI, inclusive realizei alguns projetosutilizando as tecnologias supracitadas.
