...
🎯  Cientista Social de formação, estou em migração de carreira para o desenvolvimento de software. Estou no úlitmo período do curso Tecnólogo em Análise e Desenvolvimento de Sistemas. Meu objetivo é atuar como Desenvolvedor Backend Java. 
Desejo aprimorar minhas habilidades pessoais e profissionais, contribuindo na construção de soluções que agregam valores aos cliente, levando em conta a diversidade, inclusão, sustentabilidade, eficiência!

📚 Experiências:  venho buscando aprimoração por meio de cursos online, bootcamps, projetos, dentre eles, destaco:
