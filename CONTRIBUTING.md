...
Utilize o comando `git checkout -b` para criar e alternar para a nova branch e nomeie-a como `feat/community/CerqueiraG25`
> Exemplo: `git checkout -b feat/community/CerqueriraG25`
