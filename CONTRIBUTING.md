...
Utilize o comando `git checkout -b` para criar e alternar para a nova branch e nomeie-a como `feat/community/felipelc`
> Exemplo: `git checkout -b feat/community/felipelc`
