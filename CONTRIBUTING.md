...
```bash
git clone https://github.com/julioadm/dio-lab-open-source.git
```
Pressione enter, e uma cópia do seu fork no GitHub será criada localmente.

### 3) Crie uma nova **branch** 
Utilize o comando `git checkout -b` para criar e alternar para a nova branch e nomeie-a como `feat/community/julioadm`
> Exemplo: `git checkout -b feat/community/julioadm`
