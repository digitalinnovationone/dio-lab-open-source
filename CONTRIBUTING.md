...
| ---------------|----------------------------------------------------------------------|-----------
| `feat`         | Para Adiciona uma nova funcionalidade ao projeto.                         | `feat: add USENAME.md profile`
| `fix`          | Para Corrige um bug ou problema no projeto.                               | `fix: fixed issue fix#IssueNumber`
| `docs`         | Para Altera a documentação do projeto.| `docs: update README.md`
| `style`        | Para Realiza mudanças na aparência, sem alterar a funcionalidade.         | `style: add EFFECTNAME to COMPONENT`
| `refactor`     | Para Realiza mudanças no código que não alteram a funcionalidade.         | `refactor: refactor at CLASSNAME`
| `test`         | Para Adiciona ou modifica testes no projeto.                              | `test: add unit test for UserService`
