...
| Tipo de Commit |Descrição                                                             | Emojis           | Exemplo
| ---------------|----------------------------------------------------------------------|------------------|----------------------
| `feat`         | Adiciona uma nova funcionalidade ao projeto.                         | ✨ `:sparkles:`  | `:sparkles: feat: add USENAME.md profile`
| `fix`          | Corrige um bug ou problema no projeto.                               | 🐛 `:bug:`       | `:bug: fix: fixed issue fix#IssueNumber`
| `docs`         | Altera a documentação do projeto.                                    | 📚 `:books:`     | `:books: docs: update README.md`
| `style`        | Realiza mudanças na aparência, sem alterar a funcionalidade.         | 💄 `:lipstick:`  | `:books: style: add EFFECTNAME to COMPONENT`
| `refactor`     | Realiza mudanças no código que não alteram a funcionalidade.         | ♻️ `:recycle:`   | `:recycle: refactor: refactor at CLASSNAME`
| `test`         | Adiciona ou modifica testes no projeto.                              | 🧪 `:test_tube:` | `:test_tube: test: add unit test for UserService`
