...
Utilize o comando `git checkout -b` para criar e alternar para a nova branch e nomeie-a como `feat/community/SEU_USERNAME` `git checkout -b feat/community/Urano7991` ;
