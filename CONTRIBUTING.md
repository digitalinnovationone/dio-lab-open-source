...
```bash
git clone https://github.com/OliveiraMonica10/dio-lab-open-source.git
```
Pressione enter, e uma cópia do seu fork no GitHub será criada localmente.

### 3) Crie uma nova **branch** 
Utilize o comando `git checkout -b` para criar e alternar para a nova branch e nomeie-a como feat/community/OliveiraMonica10`
> Exemplo: `git checkout -b feat/community/OliveiraMonica10`

### 4) Crie o seu Profile README
 Dentro da pasta [`community`](https://github.com/digitalinnovationone/dio-lab-open-source/tree/main/community), crie um arquivo em Markdown (extensão `OliveiraMonica10.md`) e nomeie com o mesmo nome do seu usuário no GitHub:

> Exemplo: `community/OliveiraMonica10`
...
Utilize o comando `git add community/OliveiraMonica10.md` para adicionar sua alteração (nesse caso o arquivo markdown criado)  à "staging area" no Git.

### 6) Crie um Commit
Crie um commit e adicione a mensagem indicando a adição do seu perfil:
```bash
git commit -m"feat: add OliveiraMonica10 profile"
```
>[!IMPORTANT]
...
Envie as alterações realizadas no seu repositório local para a branch `feat/community/OliveiraMonica10` no seu repositório remoto com o comando:
```bash
git push origin feat/community/OliveiraMonica10
```
>[!WARNING]
