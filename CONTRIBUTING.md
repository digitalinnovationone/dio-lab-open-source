...
> Exemplo: `community/pauloJosePj.md`
...
Utilize o comando `git add community/pauloJosePj.md` para adicionar sua alteração (nesse caso o arquivo markdown criado)  à "staging area" no Git.
