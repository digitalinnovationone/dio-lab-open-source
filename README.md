...
4. Crie/Referêncie uma nova **branch** e nomeie como `feat/community/leonardogomesv`: `git checkout -b feat/community/Leonardogomesv`;
    > Exemplo: `git checkout -b feat/community/leonardogomesv`
