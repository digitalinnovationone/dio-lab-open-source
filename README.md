...
> [!NOTE]   
> Por exemplo, a URL https://github.com/felipeacruz1/dio-lab-open-source é o "**fork**" feito pelo usuário do GitHub "`felipeacruz1`" para a contribuição no repositório `dio-lab-open-source`.
