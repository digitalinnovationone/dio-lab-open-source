...
4. Crie/Referêncie uma nova **branch** e nomeie como `feat/community/SEU_USERNAME`: `git checkout -b feat/community/issf69`;
    > Exemplo: `git checkout -b feat/community/issf69`
