...
> [!NOTE]   
> Por exemplo, a URL https://github.com/salamitos/dio-lab-open-source é o "**fork**" feito pelo usuário do GitHub "`salamitos`" para a contribuição no repositório `dio-lab-open-source`.
