...
4. Crie/Referêncie uma nova **branch** e nomeie como `feat/community/SEU_USERNAME`: `git checkout -b feat/community/Andzuo`;
    > Exemplo: `git checkout -b feat/community/Andzuo`
