...
> [!NOTE]   
> Por exemplo, a URL https://github.com/FelippeH/dio-lab-open-source é o "**fork**" feito pelo usuário do GitHub "FelippeH" para a contribuição no repositório `dio-lab-open-source`.
