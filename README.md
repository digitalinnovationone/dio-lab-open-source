...
> [!NOTE]   
> Por exemplo, a URL https://github.com/wenrs/dio-open-source é o "**fork**" feito pelo usuário do GitHub "`WenRS`" para a contribuição no repositório `dio-open-source`.
