...
4. Crie/Referêncie uma nova **branch** e nomeie como `feat/community/MaxWillander`: `git checkout -b feat/community/MaxWillander`;
    > Exemplo: `git checkout -b feat/community/MaxWillander`
