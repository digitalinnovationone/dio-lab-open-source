...
4. Crie/Referencie uma nova **branch** e nomeie como `feat/community/SEU_USERNAME`:'git checkout -b feat/community/CarlosEngineer';
    > Exemplo: 'git checkout -b feat/community/CarlosEngineer'
...
4. Create/Reference a new **branch** and name it  `git checkout -b feat/community/CarlosEngineer`;
    > Example: `git checkout -b feat/community/rafaeldscordeiro`: `git checkout -b feat/community/rafaeldscordeiro`;
