<h1>
    ...
    <span> Sergioaero1 - Contribuindo em um Projeto Open Source no GitHub</span>
</h1>
...
## OBS
ESTAMOS EM 2024. O VIDEO-AULA TEM QUE FAZER ALGUMAS ATUALIZAÇÕES PARA ENTENDER. 


---
## Desafio de Projeto da DIO
Colocar em prática meu conhecimento sobre contribuição no GitHub! <br>
...
Inserir: badges indicando suas habilidades; cards com suas estatísticas no GitHub e projetos que criou, colaborou ou que deseje que outras pessoas colaborem. Além disso, você pode inserir também links para seus desafios de projeto e artigos na plataforma da [Digital Innovation One](https://www.dio.me/). <br>
 Aprender consultando os exemplos na pasta [`community`](https://github.com/digitalinnovationone/dio-lab-open-source/tree/main/community), conferir alguns utilitários na pasta [`utils`](https://github.com/digitalinnovationone/dio-lab-open-source/tree/main/utils) e usar minha criatividade para criar o meu 😊💙.
...
[![GitHub](https://img.shields.io/badge/GitHub-100000?style=for-the-badge&logo=github&logoColor=white)](https://github.com/Sergioaero1)
