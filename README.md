...
> [!IMPORTANT]   
> Confira as instruções antes de enviar a sua contribuição em [CONTRIBUTING.md](https://github.com/digitalinnovationone/dio-lab-open-source/blob/main/CONTRIBUTING.md): 'git checkout -b feat/community/seunomedeusuario';
>  Exemplo: 'git checkout -b feat/community/angelataide'
