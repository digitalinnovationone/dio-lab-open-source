...
4. Crie uma nova **branch** e nomeie como `feat/community/dersondev`: `git checkout -b feat/community/dersondev`;
...
7. Adicione suas alterações à "staging area" com o comando `git add community/dersondev.md`;
8. Crie um commit e adicione a mensagem indicando a adição do seu perfil `git commit -m"feat: add dersondev profile"`;
9. Envie as alterações para o seu repositório remoto `git push origin feat/community/dersondev`; 
...
4. Create a new **branch** and name it as `feat/community/DersonDev`: `git checkout -b feat/community/dersondev`;
