...
> [!NOTE]   
> Por exemplo, a URL https://github.com/aksa/dio-lab-open-source é o "**fork**" feito pelo usuário do GitHub "`aksa`" para a contribuição no repositório `dio-lab-open-source`.
