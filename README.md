...
> [!NOTE]   
> Por exemplo, a URL https://github.com/daiede/dio-lab-open-source é o "**fork**" feito pelo usuário do GitHub "`daiede`" para a contribuição no repositório `dio-lab-open-source`.
...
[![GitHub Issues](https://img.shields.io/github/issues/digitalinnovationone/dio-lab-open-source?style=social)](https://github.com/digitalinnovationone/dio-lab-open-source/issues/)
 ...
 Além disso, você também pode contribuir:__
