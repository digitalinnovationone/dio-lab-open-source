...
4. Crie/Referêncie uma nova **branch** e nomeie como `feat/community/SEU_USERNAME`: `git chechout -b feat/community/seunomedeusuario`;
    > Exemplo: git checkout -b feat/community/Redmu41
