...
4. Crie uma nova **branch** e nomeie como `feat/community/lulavalenca`: `git checkout -b feat/community/lulavalenca`;
    > Exemplo: `git checkout -b feat/community/lulavalenca`
