...
4. Crie uma nova **branch** e nomeie como `feat/community/joelsousa21`: `git checkout -b feat/community/joelsousa21`;
...
4. Create a new **branch** and name it as `feat/community/joelsousa21`: `git checkout -b feat/community/joelsousa21`;
