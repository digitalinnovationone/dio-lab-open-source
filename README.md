...
4. Crie uma nova **branch** e nomeie como `feat/community/VictorrGouveaa`: `git checkout -b feat/community/VictorrGouveaa`;
    > Exemplo: `git checkout -b feat/community/VictorrGouveaa`
