...
4. Crie/Referêncie uma nova **branch** e nomeie como `feat/community/RafaelAugusto33`: `git checkout -b feat/community/seunomedeusuario`;
    > Exemplo: `git checkout -b feat/community/RafaelAugusto33`
...
7. Adicione suas alterações a "staging area" com o comando `git add community/RafaelAugusto33.md`;
8. Crie um commit e adicione a mensagem indicando a adição do seu perfil `git commit -m"feat: add RafaelAugusto33 profile"`;
9. Envie as alterações para o seu repositório remoto `git push origin feat/community/RafaelAugusto33`; 
