...
3. Adicione o remote upstream para manter seu repositório local atualizado: `git remote add upstream https://github.com/mateusramos10/dio-lab-open-source.git`;
