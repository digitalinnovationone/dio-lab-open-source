...
4. Crie/Referêncie uma nova **branch** e nomeie como `feat/community/igornz`: `git checkout -b feat/community/igornz`;
    > Exemplo: `git checkout -b feat/community/igornz`
