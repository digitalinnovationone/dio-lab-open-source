...
4. Crie uma nova **branch** e nomeie como `feat/community/georgedevfull`: `git checkout -b feat/community/georgedevfull`; git checkout -b `feat/community/georgedevfull`;
