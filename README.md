...
4. Crie/Referencie uma nova **branch** e nomeie como `feat/community/seunomedeusuario`
    > Exemplo: 'git checkout -b feat/community/Kethelynaraujo'
    > 
...
4. Create/Reference a new **branch** and name it `feat/community/seunomedeusuario`: `git checkout -b feat/community/seunomedeusuario`;
    > Example: `git checkout -b feat/community/Kethelynaraujo`
