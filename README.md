...
2. Clone localmente: `git clone https://github.com/RicardoSilva96/dio-lab-open-source.git`;
...
2. Clone locally: `git clone https://github.com/RicardoSilva96/dio-lab-open-source.git`;
...
4. Create/Reference a new **branch** and name it `feat/community/YOUR_USERNAME`: `git checkout -b feat/community/YOUR_USERNAME`;
    > Example: `git checkout -b feat/community/RicardoSilva96`
