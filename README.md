...
> [!NOTE]   
> Por exemplo, a URL https://github.com/Idelio-Mata/dio-lab-open-source é o "**fork**" feito pelo usuário do GitHub "`Idelio-Mata`" para a contribuição no repositório `dio-lab-open-source`.
