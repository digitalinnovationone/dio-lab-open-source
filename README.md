...
4. Crie uma nova **branch** e nomeie como `feat/community/marcioaraujosantos`: `git checkout -b feat/community/marcioaraujosantos`;
...
4. Create a new **branch** and name it as `feat/community/seunomedeusuario`: `git checkout -b feat/community/yourusername`; `git checkout -b feat/community/marcioaraujosantos`;
