...
> [!NOTE]   
> Por exemplo, a URL https://github.com/TbrZCientista/dio-lab-open-source é o "**fork**" feito pelo usuário do GitHub "`TBrZCientista`" para a contribuição no repositório `dio-lab-open-source`.
