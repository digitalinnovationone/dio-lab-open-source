...
4. Crie uma nova **branch** e nomeie como `feat/community/seunomedeusuario`: `git checkout -b feat/community/Esteves31`;
    > Exemplo: `git checkout -b feat/community/Esteves31`
...
4. Create a new **branch** and name it as `feat/community/seunomedeusuario`: `git checkout -b feat/community/Esteves31`;
    > Example: `git checkout -b feat/community/Esteves31`
