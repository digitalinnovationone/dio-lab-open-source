...
4. Crie uma nova **branch** e nomeie como `feat/community/seunomedeusuário`: `git checkout -b feat/community/seunomedeusuário`;
    > Exemplo: `git checkout -b feat/community/seunomedeusuário`
...
4. Create a new **branch** and name it as `feat/community/seunomedeusuario`: `git checkout -b feat/community/carlos738`;
    > Example: `git checkout -b feat/community/carlos738`
