...
4. Crie uma nova **branch** e nomeie como `feat/community/seunomedeusuario`:`git chekout -b feat/community/seunomedeusuario` `git checkout -b feat/community/seunomedeusuario`;
