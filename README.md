...
> [!NOTE]   
> Por exemplo, a URL https://github.com/Castmandt/dio-lab-open-source é o "**fork**" feito pelo usuário do GitHub "`Castmandy`" para a contribuição no repositório `dio-lab-open-source`.
