...
4. Crie/Referêncie uma nova **branch** e nomeie como `feat/community/perealvees: `git checkout -b feat/community/perealvees`;
    > Exemplo: `git checkout -b feat/community/perealvees`
