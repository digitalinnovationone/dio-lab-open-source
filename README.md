...
> [!NOTE]   
> Por exemplo, a URL https://github.com/falvojr/dio-lab-open-source é o "**fork**" feito pelo usuário do GitHub "`OliveiraMonica10`" para a contribuição no repositório `dio-lab-open-source`.
