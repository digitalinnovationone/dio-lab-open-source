...
> [!NOTE]   
> Por exemplo, a URL https://github.com/loureiropatrick/dio-lab-open-source é o "**fork**" feito pelo usuário do GitHub "`loureiropatrick`" para a contribuição no repositório `dio-lab-open-source`.
