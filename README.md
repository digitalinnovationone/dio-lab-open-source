...
4. Crie/Referêncie uma nova **branch** e nomeie como `feat/community/SEU_USERNAME`: `git checkout -b feat/community/eltonsa75`;
    > Exemplo: `git checkout -b feat/community/eltonsa75`
...
4. Create/Reference a new **branch** and name it `feat/community/YOUR_USERNAME`: `git checkout -b feat/community/eltonsa75`;
    > Example: `git checkout -b feat/community/eltonsa75`
