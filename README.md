...
> [!NOTE]   
> Por exemplo, a URL [https://github.com/falvojr/dio-lab-open-source](https://github.com/GustavoVito/dio-lab-open-source.git) é o "**fork**" feito pelo usuário do GitHub "`GustavoVito`" para a contribuição no repositório `dio-lab-open-source`.
