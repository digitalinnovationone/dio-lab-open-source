...
> [!NOTE]   
> Por exemplo, a URL https://github.com/pleguas/dio-lab-open-source-pleguas é o "**fork**" feito pelo usuário do GitHub "`pleguas`" para a contribuição no repositório `dio-lab-open-source`.
