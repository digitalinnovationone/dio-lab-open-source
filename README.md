...
4. Crie uma nova **branch** e nomeie como `feat/community/JoaoPedro019`: `git checkout -b feat/community/JoaoPedro019`;
    > Exemplo: `git checkout -b feat/community/JoaoPedro019`
