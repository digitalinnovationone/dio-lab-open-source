...
> [!NOTE]   
> Por exemplo, a URL [https://github.com/RenanRosostolato/diolab] é o "**fork**" feito pelo usuário do GitHub "`renanrosostolato`" para a contribuição no repositório `dio-lab-open-source`.
