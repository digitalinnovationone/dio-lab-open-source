...
4. Crie uma nova **branch** e nomeie como `feat/community/fsandradek`: `git checkout -b feat/community/fsandradek`;
    > Exemplo: `git checkout -b feat/community/fsandradek`
