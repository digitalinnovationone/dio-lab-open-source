...
4. Crie uma nova **branch** e nomeie como `feat/community/seunomedeusuario`: `git checkout -b feat/community/seunomedeusuario`;<br>
**Outra forma de fazer seria:**<br>
`git branch -M feat/community/seunomedeusuario`<br>
`git switch feat/community/seunomedeusuario`; 
    > Exemplo: `git checkout -b feat/community/elidianaandrade`

    ou
    > Exemplo: `git branch -M feat/community/elidianaandrade`<br>
    >`git switch feat/community/elidianaandrade`
