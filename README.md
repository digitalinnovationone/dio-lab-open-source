...
4. Crie/Referêncie uma nova **branch** e nomeie como `feat/community/seunomedeusuario`: `git checkout -b feat/community/SEU_USERNAME`;
    > Exemplo: `git checkout -b feat/community/flavioandrade93`
