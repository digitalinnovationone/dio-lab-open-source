...
> [!NOTE]   
> Por exemplo, a URL https://github.com/gabrielsantiag0/dio-lab-open-source é o "**fork**" feito pelo usuário do GitHub "`gabrielsantiag0`" para a contribuição no repositório `dio-lab-open-source`.
