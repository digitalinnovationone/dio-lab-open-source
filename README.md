...
> [!NOTE]   
> Por exemplo, a URL https://github.com/vitorsullivandev/dio-lab-open-source é o "**fork**" feito pelo usuário do GitHub "`vitorsullivandev`" para a contribuição no repositório `dio-lab-open-source`.
