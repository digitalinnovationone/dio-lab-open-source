...
2. Clone localmente: `git clone https://github.com/william-rende/dio-lab-open-source.git`;
...
4. Crie/Referêncie uma nova **branch** e nomeie como `feat/community/william-rende`: `git checkout -b feat/community/william-rende`;
...
7. Adicione suas alterações a "staging area" com o comando `git add community/william-rende.md`;
8. Crie um commit e adicione a mensagem indicando a adição do seu perfil `git commit -m"feat: add william-rende profile"`;
9. Envie as alterações para o seu repositório remoto `git push origin feat/community/william-rende`; 
10. Crie um **Pull Request**.

### Instructions (EN/US)
1. **Fork** this repository;
2. Clone locally: `git clone https://github.com/william-rende/dio-lab-open-source.git`;
...
4. Create/Reference a new **branch** and name it `feat/community/william-rende`: `git checkout -b feat/community/william-rende`;
...
7. Add your changes to the "staging area" with the command `git add community/william-rende.md`;
8. Create a commit and add a message indicating the addition of your profile `git commit -m"feat: add william-rende profile"`;
9. Push the changes to your remote repository `git push origin feat/community/william-rende`;
10. Create a **Pull Request**.

### Instrucciones (ES/ES)
1. Haz un **Fork** de este repositorio;
2. Clona localmente: `git clone https://github.com/william-rende/dio-lab-open-source.git`;
...
4. Crea/Referencia una nueva **branch** y nómbrala `feat/community/william-rende`: `git checkout -b feat/community/william-rende`;
...
7. Agrega tus cambios al "área de preparación" con el comando `git add community/william-rende.md`;
8. Crea un commit y añade un mensaje indicando la adición de tu perfil `git commit -m"feat: add william-rende profile"`;
9. Envía los cambios a tu repositorio remoto `git push origin feat/community/william-rende`;
