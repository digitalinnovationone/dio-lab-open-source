...
> [!NOTE]   
> Por exemplo, a URL https://github.com/CaiqueJSilva/dio-lab-open-source é o "**fork**" feito pelo usuário do GitHub "`CaiqueJsilva`" para a contribuição no repositório `dio-lab-open-source`.
