...
4. Crie uma nova **branch** e nomeie como `feat/community/seunomedeusuario`: `git checkout -b feat/community/seunomedeusuario`; alterando para alterar
    > Exemplo: `git checkout -b feat/community/elidianaandrade` alterando para alterar
