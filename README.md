...
4. Create a new **branch** and name it as `feat/community/seunomedeusuario`: 'git checkout -b' `git checkout -b feat/community/yourusername`;
    > Example: 'git checkout -b' `git checkout -b feat/community/elidianaandrade`
