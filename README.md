...
2. Clone localmente: `git clone https://github.com/memellin/dio-lab-open-source.git`;
...
4. Crie/Referêncie uma nova **branch** e nomeie como `feat/community/memellin`: `git checkout -b feat/community/memellin`;
...
7. Adicione suas alterações a "staging area" com o comando `git add community/memellin.md`;
8. Crie um commit e adicione a mensagem indicando a adição do seu perfil `git commit -m"feat: add memellin profile"`;
9. Envie as alterações para o seu repositório remoto `git push origin feat/community/memellin`; 
