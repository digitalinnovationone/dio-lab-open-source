<h1>
    ...
    <span> Contribuindo em um Projeto Open Source no GitHub GitHub</span>
</h1>
...
4. Create a new **branch** and name it as `feat/community/seunomedeusuario`: `git checkout -b feat/community/yourusername` `git checkout -b feat/community/yourusername`;
