...
> [!NOTE]   
> Por exemplo, a URL https://github.com/Claudioteo01/dio-lab-open-source é o "**fork**" feito pelo usuário do GitHub "`Claudioteo01`" para a contribuição no repositório `dio-lab-open-source`.
