...
[![Forks](https://img.shields.io/github/forks/digitalinnovationone/dio-lab-open-source?style=social)](https://github.com/digitalinnovationone/dio-lab-open-source/forks) ou 'git feat upstream main'para baixar sem mesclar.Veja mais em:[primeiros passos com git e github](https://github.com/Marilenesant-hub/dio-curso-git-github/bran/mainmateriais-de-apoio/01-primeiros-passos-com-git-e-github.md) 
4. Crie uma nova **branch** e nomeie como 'feat/community/Marilenesant-hub'|'git checkout -b feat/community/Marilenesant-hub' > Exemplo: 'git checkout -b feat/community/Marilenesant-hub'
