...
4. Crie uma nova **branch** e nomeie como `feat/community/seunomedeusuario`: `git checkout -b feat/community/seunomedeusuario`: `git checkout -b feat/community/rayllander15`;
    > Exemplo: `git checkout -b feat/community/elidianaandrade`: `git checkout -b feat/community/rayllander15`;
...
4. Create a new **branch** and name it as `feat/community/rayllander15`: `git checkout -b feat/community/rayllander15`;
    > Example: `git checkout -b feat/community/rayllander15`
