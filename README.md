...
4. Crie/Referêncie uma nova **branch** e nomeie como `feat/community/SEU_USERNAME`: `git checkout - b16 feat/community/SEU_USERNAME`;
    > Exemplo: `git checkout -b16 feat/community/Cute1998`
