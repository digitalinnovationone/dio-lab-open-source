...
2. Clone localmente: `git clone https://github.com/USERNAME/dio-lab-open-source.git`;
...
4. Crie/Referêncie uma nova **branch** e nomeie como `feat/community/USERNAME`:
    > Exemplo: git checkout -b feat/community/USERNAME
...
7. Adicione suas alterações a "staging area" com o comando `git add community/USERNAME.md`;
8. Crie um commit e adicione a mensagem indicando a adição do seu perfil `git commit -m"feat: add USERNAME profile"`;
9. Envie as alterações para o seu repositório remoto `git push origin feat/community/USERNAME`; 
10. Crie um **Pull Request**.

### Instructions (EN/US)
1. **Fork** this repository;
2. Clone locally: `git clone https://github.com/USERNAME/dio-lab-open-source.git`;
...
4. Create/Reference a new **branch** and name it `feat/community/USERNAME`: `git checkout -b feat/community/USERNAME`;
    > Example: `git checkout -b feat/community/USERNAME`
...
7. Add your changes to the "staging area" with the command `git add community/USERNAME.md`;
8. Create a commit and add a message indicating the addition of your profile `git commit -m"feat: add USERNAME profile"`;
9. Push the changes to your remote repository `git push origin feat/community/USERNAME`;
...
4. Crea/Referencia una nueva **branch** y nómbrala `feat/community/USERNAME`: `git checkout -b feat/community/USERNAME`;
    > Ejemplo: `git checkout -b feat/community/USERNAME`
...
7. Agrega tus cambios al "área de preparación" con el comando `git add community/USERNAME.md`;
8. Crea un commit y añade un mensaje indicando la adición de tu perfil `git commit -m"feat: add USERNAME profile"`;
9. Envía los cambios a tu repositorio remoto `git push origin feat/community/USERNAME`;
