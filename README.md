...
4. Crie/Referêncie uma nova **branch** e nomeie como `feat/community/alrimarleskovar`: 'git checkout -b feat/community/alrimarleskovar'
    > Exemplo: git checkout -b feat/community/alrimarleskovar
...
4. Create/Reference a new **branch** and name it `feat/community/alrimarleskovar`: `git checkout -b feat/community/alrimarleskovar`;
    > Example: `git checkout -b feat/community/alrimarleskovar`
