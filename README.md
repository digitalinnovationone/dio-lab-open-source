...
4. Crie uma nova **branch** e nomeie como `feat/community/thiago-breis`: `git checkout -b feat/community/thiago-breis`;
    > Exemplo: `git checkout -b feat/community/thiago-breis`
