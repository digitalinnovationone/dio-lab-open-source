...
4. Crie/Referêncie uma nova **branch** e nomeie como `feat/community/SEU_USERNAME`: `git checkout -b feat/community/seunomedeusuario`; `git checkout -b feat/community/SeunomedeUsuário`; 
    > Exemplo: `git checkout -b feat/community/ORafaBrazil`
