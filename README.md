...
4. Crie/Referêncie uma nova **branch** e nomeie como `feat/community/SEU_USERNAME`: `git checkout -b feat/community/SEU_USERNAME`; feat/community/zzruanxx`:  git checkout -b feat/community/zzruanxx
