...
> [!NOTE]   
> Por exemplo, a URL https://github.com/LeoBAlves/dio-lab-open-source é o "**fork**" feito pelo usuário do GitHub "`LeoBAlves`" para a contribuição no repositório `dio-lab-open-source`.
