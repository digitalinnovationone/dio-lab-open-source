...
> [!IMPORTANT]   
> Confira as instruções antes de enviar a sua contribuição em git checkout -b [CONTRIBUTING.md](https://github.com/digitalinnovationone/dio-lab-open-source/blob/main/CONTRIBUTING.md)
