...
> [!NOTE]   
> Por exemplo, a URL https://github.com/marcellytholanda/dio-lab-open-source é o "**fork**" feito pelo usuário do GitHub "`marcellytholanda`" para a contribuição no repositório `dio-lab-open-source`.
