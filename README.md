...
4. Crie uma nova **branch** e nomeie como `feat/community/marcosvg12`: `git checkout -b feat/community/marcosvg12`;
    > Exemplo: `git checkout -b feat/community/marcosvg12`
