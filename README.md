...
> [!NOTE]   
> Por exemplo, a URL https://github.com/VictorVdoS/dio-lab-open-source é o "**fork**" feito pelo usuário do GitHub "`VictorVdoS`" para a contribuição no repositório `dio-lab-open-source`.
