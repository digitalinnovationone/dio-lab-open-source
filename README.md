...
> [!NOTE]   
> Por exemplo, a URL https://github.com/rodrigofontes92/dio-lab-open-source é o "**fork**" feito pelo usuário do GitHub "`rodrigofontes92`" para a contribuição no repositório `dio-lab-open-source`.
