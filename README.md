...
> [!NOTE]   
> Por exemplo, a URL https://github.com/R-Ayalos/dio-lab-open-source é o "**fork**" feito pelo usuário do GitHub "`R-Ayalos`" para a contribuição no repositório `dio-lab-open-source`.
