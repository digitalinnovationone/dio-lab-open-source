...
> [!NOTE]   
> Por exemplo, a URL https://github.com/amandacsmag/dio-lab-open-source é o "**fork**" feito pelo usuário do GitHub "`amandacsmag`" para a contribuição no repositório `dio-lab-open-source`.
