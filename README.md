...
[![Link do Lab](https://img.shiel<h1>
...
Claro! Aqui está a versão com a numeração formatada para facilitar a cópia:

1. Fai un **Fork** di questo repository;  
2. Clona localmente: `git clone https://github.com/TUO_USERNAME/dio-lab-open-source.git`;  
3. Aggiungi il remote upstream per mantenere il tuo repository locale aggiornato. Ad esempio: `git remote add upstream https://github.com/digitalinnovationone/dio-lab-open-source.git`;  
   > Utilizza il comando `git pull upstream main` per scaricare e unire le modifiche nel tuo repository locale basato sul branch `main` di questo repository originale da cui hai fatto il fork, oppure `git fetch upstream main` per scaricare senza unire. Vedi di più in: [Primi Passi con Git e GitHub](https://github.com/digitalinnovationone/dio-curso-git-github/blob/main/materiais-de-apoio/03-primeiros-passos-com-git-e-github.md).  
4. Crea/Riferisci un nuovo **branch** e nomina come `feat/community/TUO_USERNAME`: `git checkout -b feat/community/TUO_USERNAME`;  
   > Esempio: `git checkout -b feat/community/elidianaandrade`  
5. All'interno della cartella [`community`](https://github.com/digitalinnovationone/dio-lab-open-source/tree/main/community), crea un file in Markdown (estensione `.md`) e nomina con lo stesso nome del tuo utente su GitHub;  
   > Esempio: `elidianaandrade.md` <br>  
6. Sviluppa il tuo profilo. Per questo, puoi vedere esempi nella cartella [`community`](https://github.com/digitalinnovationone/dio-lab-open-source/tree/main/community) e aggiungere alcuni degli strumenti presenti nella cartella [`utils`](https://github.com/digitalinnovationone/dio-lab-open-source/tree/main/utils);  
   > **Nota:** Usa gli altri esempi come ispirazione e non come copia.  
7. Aggiungi le tue modifiche all'area di staging con il comando `git add community/TUO_USERNAME.md`;  
8. Crea un commit e aggiungi il messaggio che indica l'aggiunta del tuo profilo `git commit -m"feat: add TUO_USERNAME profile"`;  
9. Invia le modifiche al tuo repository remoto `git push origin feat/community/TUO_USERNAME`;  
10. Crea un **Pull Request**.  
...
ds.io/badge/Acesse%20o%20Lab%20na%20Plataforma-E94D5F?style=for-the-badge)](https://web.dio.me/lab/desafio-de-projeto-contribuindo-em-um-projeto-open-source-no-github/learning/913f26fd-1018-4643-b59a-6356ea77dc2e)
