...
4. Crie uma nova **branch** e nomeie como `feat/community/seunomedeusuario`: `git checkout -b feat/community/Maria18isabelle905`;
    > Exemplo: `git checkout -b feat/community/Maria18isabelle905`
