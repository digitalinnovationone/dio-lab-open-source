...
4. Crie/Referencie uma nova **branch** e nomeie como `feat/community/seunomedeusuario`:'git checkout -b feat/community/Fal1nn1'
    > Exemplo: 'git checkout -b feat/community/Fal1nn1'
