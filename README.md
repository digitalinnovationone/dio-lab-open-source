...
4. Crie uma nova **branch** e nomeie como `feat/community/seunomedeusuario`: `git checkout -b feat/community/lucasscoutinhoo`; `git checkout -n feat/community/lucasscoutinhoo`;
    > Exemplo: `git checkout -b feat/community/lucasscoutinhoo`
    > Exemplo2:`git checkout -b feat/communty/seunometeste`
