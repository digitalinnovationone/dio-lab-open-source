...
4. Crie uma nova **branch** e nomeie como `feat/community/VictorTiagoFSilva`: `git checkout -b feat/community/VictorTiagoFSilva`;
    > Exemplo: `git checkout -b feat/community/VictorTiagoFSilva`
