...
> [!NOTE]   
> Por exemplo, a URL https://github.com/falvojr/dio-lab-open-source é o "**fork**" feito pelo usuário do GitHub "`akilly`" para a contribuição no repositório `dio-lab-open-source`.
