...
4. Crie/Referêncie uma nova **branch** e nomeie como `feat/community/Angel-Fernandes`: `git checkout -b feat/community/Angel-Fernandes`;
    > Exemplo: `git checkout -b feat/community/Angel-Fernandes`
