...
> [!NOTE]   
> Por exemplo, a URL https://github.com/caioalmeidacl/dio-lab-open-source é o "**fork**" feito pelo usuário do GitHub caioalmeidacl para a contribuição no repositório `dio-lab-open-source`.
