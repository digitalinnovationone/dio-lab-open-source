...
> [!NOTE]   
> Por exemplo, a URL https://github.com/falvojr/dio-lab-open-source é o ["**fork**"](https://docs.github.com/pt/pull-requests/collaborating-with-pull-requests/working-with-forks/fork-a-repo" "Clique e relembre como fazer um fork") feito pelo usuário do GitHub "`falvojr`" para a contribuição no repositório `dio-lab-open-source`.
