...
> [!NOTE]   
> Por exemplo, a URL https://github.com/brunettial/dio-lab-open-source é o "**fork**" feito pelo usuário do GitHub "`falvojr`" para a contribuição no repositório `dio-lab-open-source`.
