...
4. Crie/Referêncie uma nova **branch** e nomeie como `feat/community/USER_NAME`:
    > Exemplo: git checkout -b feat/community/igusouz
...
4. Create/Reference a new **branch** and name it `feat/community/YOUR_USERNAME`: `git checkout -b feat/community/igusouz`;
    > Example: `git checkout -b feat/community/igusouz`
