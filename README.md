...
4. Crie/Referencie uma nova **branch** e nomeie como `feat/community/seunomedeusuario`:'git  feat/community/seunomedeusuario'
    > Exemplo: 'git  feat/community/AlcidesThiago2016'
