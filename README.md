...
2. Clone localmente: `git clone https://github.com/Jef-Oliver/dio-lab-open-source.git`;
...
4. Crie uma nova **branch** e nomeie como `feat/community/Jef-Oliver`: `git checkout -b feat/community/Jef-Oliver`;
    > Exemplo: `git checkout -b feat/community/Jef-Oliver`
...
7. Adicione suas alterações à "staging area" com o comando `git add community/Jef-Oliver.md`;
8. Crie um commit e adicione a mensagem indicando a adição do seu perfil `git commit -m"feat: add Jef-Oliver profile"`;
9. Envie as alterações para o seu repositório remoto `git push origin feat/community/Jef-Oliver`; 
