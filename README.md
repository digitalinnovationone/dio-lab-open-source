...
### Instruções (PT/BR)
1. Abra o Git bash, crie uma pasta utilizando o comando mkdir "nome da pasta" em seguida entre na pasta utilizando o comando cd "nome da pasta" por fim dentro da pasta do projeto, use o comando git init para inicializar o repositório.
2.  Faça um **Fork** deste repositório;
3. Clone localmente: `git clone https://github.com/SEUUSERNAME/dio-lab-open-source.git`;
...
### Instructions (EN/US)
1. Open Git bash, create a folder using the mkdir command "folder name" then enter the folder using the cd command "folder name" finally inside the project folder, use the git init command to initialize the repository.
2. **Fork** the repository;
3. Clone locally: `git clone https://github.com/SEUUSERNAME/dio-lab-open-source.git`;
4. Add upstream remote to keep your local repository up to date: `git remote add upstream https://github.com/elidianaandrade/dio-lab-open-source.git`;
...
5. Create a new **branch** and name it as `feat/community/seunomedeusuario`: `git checkout -b feat/community/yourusername`;
    > Example: `git checkout -b feat/community/elidianaandrade`
6. Inside the folder [`community`](https://github.com/elidianaandrade/dio-lab-open-source/tree/main/community), create a file in Markdown (extension `.md`) and name it the same as your GitHub username;
    > Example: `elidianaandrade.md` <br>
7. Develop your profile. For this you can see examples in the folder [`community`](https://github.com/elidianaandrade/dio-lab-open-source/tree/main/community) and add some of the utilities present in the folder [`utils`](https://github.com/elidianaandrade/dio-lab-open-source/tree/main/utils);
    > **Note:** Use the other examples as inspiration, not copy.
8. Add your changes to the "staging area" with the command `git add community/yourusername.md`;
9. Create a commit and add the message indicating the addition of your profile `git commit -m"feat: add yourusername profile"`;
10. Push changes to your remote repository `git push origin feat/community/yourusername`; 
