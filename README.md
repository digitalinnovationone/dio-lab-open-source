...
> [!NOTE]   
> Por exemplo, a URL https://github.com/lucascamourao/dio-lab-open-source é o "**fork**" feito pelo usuário do GitHub "`lucascamourao`" para a contribuição no repositório `dio-lab-open-source`.
