...
Utilize o comando `git checkout -b` para criar e alternar para a nova branch e nomeie-a como `feat/community/PedroTrimboli`
> Exemplo: `git checkout -b feat/community/PedroTrimboli`
