...
Sou um Analista de Sistemas, com uma sólida formação acadêmica em Tecnologia da Informação pela ETEC e atualmente cursando Segurança da Informação na FATEC. Minha jornada profissional é marcada por uma ampla experiência com tecnologia.

Minha expertise abrange o desenvolvimento de sistemas utilizando Java, juntamente com ferramentas e frameworks modernos como Spring Boot e GIT. Tenho habilidades em bancos de dados tanto relacionais, como MySQL, quanto NoSQL, como Cassandra.

Além disso, tenho me especializado no conhecimento de práticas DevOps, estudando ferramentas de Cloud Computing da AWS, infraestrutura como código com o Vagrant, automações em Python e Bash, CI/CD, Docker e outras tecnologias relevantes do ecossistema DevOps.
