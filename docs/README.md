...
O objetivo do Desafio é exercitar a forma de contribuir em projetos open source que são hospedados no GitHub. Assim o aluno pode treinar comando de git e funcionalidades do próprio GitHub através de um desafio prático.
