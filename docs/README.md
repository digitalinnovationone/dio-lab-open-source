...
Crie uma nova **branch** e nomeie como "feat/comunity/seunomedeusuario" : git checkout -b "feat/comunity/seunomedeusuario":
**Exemplo**:  git checkout -b "feat/comunity/julic-123"
