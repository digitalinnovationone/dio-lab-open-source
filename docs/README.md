...
Ao contribuir, não esqueça de:
- Usar títulos claros e objetivos;
- Optar por frases curtas e diretas;
- Explicar o "porquê", não apenas o "como";
- Manter exemplos simples e funcionais;
- Adaptar os termos tendo em conta o público iniciante;
  
**Documentação também é código! Mantenha consistência e organização.**
