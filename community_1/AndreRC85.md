...
Me chamo André Rodrigues, estou graduando no curso de Engenharia de Computação pela UNIUBE - Universidade de Uberaba.

Atuei por 3 anos como Desenvolvedor de Software Quadient Inspire Designer, Interactive, Scaler. Analise, com ajuste e criação de template e script's, implementaçãoo de soluções TI.
